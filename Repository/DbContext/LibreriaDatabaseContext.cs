...
{
    public partial class LibreriaDatabaseContext : DbContext
    {
        public LibreriaDatabaseContext()
        {
        }

        public LibreriaDatabaseContext(DbContextOptions<LibreriaDatabaseContext> options)
            : base(options)
        {
        }
